						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown mega-menu">
								<a class="dropdown-toggle" href="#" data-toggle="dropdown" data-hover="dropdown">
									Mega Menu <i class="icon-arrow"></i>
								</a>
								<ul class="dropdown-menu">
									<li>
											...
											<div class="row">
												<div class="col-md-3">
													<ul class="mega-sub-menu">
														<li>
															<span class="mega-menu-sub-title">Forms</span>
															<ul class="mega-sub-menu">
																<li class="active">
												...
												<div class="col-md-3">
													<ul class="mega-sub-menu">
														<li>
															<span class="mega-menu-sub-title">File Upload</span>
															<ul class="mega-sub-menu">
																<li>
												...
												<div class="col-md-3">
													<ul class="mega-sub-menu">
														<li>
															<span class="mega-menu-sub-title">Pages</span>
															<ul class="mega-sub-menu">
																<li>
